<template>
  ...
  <div id="search" :class="{'search-open':!$store.state.headerStatus}">
    ...
    <div class="weui-search-bar" id="search_bar" :class="{'weui-search-bar_focusing':!$store.state.headerStatus}">
      ...
      <a class="weui-search-bar__cancel-btn" id="search_cancel" @click="$store.commit('toggleHeaderStatus',true)">取消</a>
    </div>
    ...
    <article>
      ...
      <div class="weui-cells" @click="go">
          <a class="weui-cell weui-cell_access" >
            <div class="weui-cell__hd">
              <img src="../../assets/images/book.png" alt="" style="width:20px;margin-right:5px;display:block">
            </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            go(){
               this.$router.push({path:'./explore/moments'})
            }
        }
    }
</script>
